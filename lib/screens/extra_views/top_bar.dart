...
class TopBarForLogin extends StatelessWidget {
  ...
  const TopBarForLogin({Key? key, this.titleStart, required this.titleEnd, required this.alignment, this.size = 24}) : super(key: key);
...
class TopBarForInView extends StatelessWidget {
  ...
  const TopBarForInView({Key? key, required this.title, this.child, this.verticalChild, this.backIcon, this.size = 35, this.onTap}) : super(key: key);
