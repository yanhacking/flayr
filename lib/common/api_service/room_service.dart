...
class RoomService {
  ...
  void makeRoomAdmin(num? roomId, num? userId, Function(RoomMember? member) completion) {
    var param = {Param.userId: userId, Param.roomId: roomId};
    ApiService.shared.call(
  ...
  void removeAdminFromRoom(num? roomId, num? userId, Function(RoomMember? member) completion) {
    var param = {Param.userId: userId, Param.roomId: roomId};
    ApiService.shared.call(
  ...
  void fetchRoomAdmins(num? roomId, Function(List<RoomMember> users) completion) {
    var param = {
      Param.roomId: roomId,
    };
    ApiService.shared.call(
  ...
  Future<void> fetchRoomUsersList(num roomId, num start, Function(List<RoomMember> users) completion) async {
    var param = {
      Param.roomId: roomId,
      Param.start: start,
  ...
  void deleteRoom(num roomId, Function() completion) {
    var param = {Param.roomId: roomId, Param.userId: SessionManager.shared.getUserID()};
    ApiService.shared.call(
  ...
  void muteUnmuteNotification(num isMute, num roomId, Function() completion) {
    var param = {Param.userId: SessionManager.shared.getUser()?.id ?? 0, Param.isMute: isMute, Param.roomId: roomId};
    ApiService.shared.call(
  ...
  void fetchRoomRequestList(num roomId, Function(List<Invitation> invitation) completion) {
  ...
  Future<void> searchUserForInvitation(num roomId, String keyword, int start, Function(List<User> users) completion) async {
    var param = {Param.roomId: roomId, Param.myUserId: SessionManager.shared.getUserID(), Param.start: start, Param.keyword: keyword, Param.limit: Limits.pagination};
  ...
  void fetchRoom(int roomId, Function(Room room) completion, {bool shouldShowMembers = false}) {
    var param = {
      Param.roomId: roomId,
  ...
  void getInvitationList(int start, Function(List<Invitation> invitations) completion) {
    var param = {Param.userId: SessionManager.shared.getUserID(), Param.start: start, Param.limit: Limits.pagination};
    ApiService.shared.call(
  ...
  void reportRoom(num roomId, String reason, String desc) {
    var param = {Param.roomId: roomId, Param.reason: reason, Param.desc: desc, Param.userId: SessionManager.shared.getUserID()};
    ApiService.shared.call(
  ...
  Future<void> fetchRoomByInterest(int interestId, int start, Function(List<Room> rooms) completion) async {
    var param = {Param.userId: SessionManager.shared.getUserID(), Param.interestId: interestId, Param.start: start, Param.limit: Limits.pagination};
    await ApiService.shared.call(
  ...
  Future<void> fetchRooms(Function(List<Room> rooms) completion) async {
    var param = {Param.limit: Limits.pagination, Param.userId: SessionManager.shared.getUserID()};
    await ApiService.shared.call(
  ...
  void createOrEditRoom({
    ...
    var param = {Param.roomId: roomId ?? 0, Param.adminId: SessionManager.shared.getUserID(), Param.title: title, Param.desc: description, Param.isPrivate: isPrivate, Param.isEnableRequest: isEnableJoin, Param.interestIds: interestsIds};
