...
class ReportSheet extends StatelessWidget {
  ...
  const ReportSheet({Key? key, this.user, this.room, this.post, this.reel}) : super(key: key);
          ...
          child: Wrap(
            children: [
              ...
              CommonSheetButton(
                ...
                onTap: () {
                  controller.submitReport(room, post, user, reel);
                },
              )
            ],
          ),
        ...
        builder: (context) {
          return Container(
            ...
            child: DropdownButton<SettingCommon>(
              ...
              items: controller.reasons.map<DropdownMenuItem<SettingCommon>>((SettingCommon value) {
